              ...
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <div class="testimonial-item">
                    ...
                    <h3>Rozy Rozy</h3>
                    <h4>Ceo &amp; Multech.TC</h4>
                    <p class="text-left">
                      Sebuah usahan yang bagus dari tim Acier Energy. Sudah menciptakan sebuah pembangkit listrik yang ramah lingkungan..
                    </p>
                  </div>
                </div>
                <div class="carousel-item">
                  <div class="testimonial-item">
                      <img src="../assets/testimonial-1.jpg" class="testimonial-img" alt="">
                      <h3>Rozy Rozy</h3>
                      <h4>Founder EvenKita</h4>
                      <p class="text-left">
                        Inovasi keren dari anak bangsa yang patut kita apresiasi, kita dukung. Maju terus untuk tim Acier Energy.
                      </p>
                    </div>
                </div>
                <div class="carousel-item">
    ...
    <section id="team" class="section-bg pt-3">
      <div class="container">
        <div class="section-header text-center">
          ...
          <p>Berkenalan dengan para pengembang dari Acier Energy.</p>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                  ...
                  <div class="footer-info">
                    <h3>ACIER ENERGY</h3>
                    <p>Memberikan inovasi dalam menciptakan pembangkit listrik ramah lingkungan.</p>
                  </div>
                ...
                <div class="col-sm-6">
                  ...
                  <div class="footer-links">
                    <h4>Hubungi Kami</h4>
                    <p>
                      Jalan Mayor Bismo No.223 Jongbiru Semampir Kediri Jawa Timur<br>
                      <strong>Telepon:</strong>( 0354 ) 771XXX<br>
                      <strong>Email:</strong> acier.energy@gmail.com<br>
                    </p>
                  </div>
<!-- 
          ...
          <div class="col-lg-6">
            ...
            <div class="form">
              ...
              <h4 class="send-message">Hubungi Operator Acier Energy </h4>
              <p>Layanan dari kami untuk kepada pelanggan untuk memberikan informasi produk,</p>
              <form action="" method="post" role="form" class="contactForm">
                ...
                <div id="sendmessage">Terimakasih telah menggunakan layanan ini</div>
...
.main-nav .drop-down ul {
  ...
  padding: 10px 0;
  background: #fff;
  box-shadow: 0px 0px 10px rgba(140, 149, 172, 0.25);
...
#services .box {
  ...
  background: #fff;
  box-shadow: 0 5px 5px 0 rgb(92, 112, 167, 0.1);
